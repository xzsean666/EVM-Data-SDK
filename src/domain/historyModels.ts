...
export interface HistoryInitialState {
  /** The exact block represented by this externally supplied state. */
  ...
  readonly nativeIn?: string;
  readonly nativeOut?: string;
  readonly nativeBalance?: string;
  readonly transactionCount?: number;
  readonly warnings?: readonly string[];
}
export interface HistoryReplayRequest extends HistoryAddressRequest { readonly fromBlock?: string; readonly toBlock?: string; readonly force?: boolean; readonly reason?: string; readonly initialState?: HistoryInitialState; }
